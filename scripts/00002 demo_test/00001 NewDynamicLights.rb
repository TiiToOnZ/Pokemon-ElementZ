...
module NuriYuri
  module DynamicLight
    LIGHTS.push([:normal, 'dynamic_light/wall_light_48']) # index 3
    LIGHTS.push([:normal, 'dynamic_light/circle_32_purple']) # index 4
    LIGHTS.push([:normal, 'dynamic_light/circle_320Red']) # index 5
    LIGHTS.push([:normal, 'dynamic_light/circle_320Blue']) # index 6
    ANIMATIONS.push({ zoom: [50], opacity: [170] }) # index 3
    ANIMATIONS.push({ zoom: [50], opacity: [150] }) # index 4
  end
end